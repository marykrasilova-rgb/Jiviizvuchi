const CACHE='maria-diary-v6';
const SHELL=['/app','/diary.html','/diary.css','/diary.js','/diary-enhancements.js','/voice-cards.js','/theme-test.js','/deep-wave.js','/site-translations.js','/site-language.js','/site-language.css','/manifest.webmanifest','/assets/icon.svg'];
